...
<div class="panel panel-primary">
    <div class="panel-heading"><h3 class="panel-title">Jawablah pertanyaan berikut ini [<?=$row->kode_gejala?>]</h3></div>
    <div class="panel-body">
        <h3>Apakah Anda Mengalami <?=strtolower($row->nama_gejala)?>?</h3>
