...
<div class="page-header">
    <h3 style="color: #fffff;">Silahkan Isi Data Diri Anda</h3>
</div>
<form action="?m=daftar" method="post">
  <div class="form-group" style="width: 400px">
                <p style="color: #fffff;" align="left"><b>Nama Lengkap</b> <span class="text-danger">*</span></p>
                <p><input class="form-control" style="width: 400px" type="text" placeholder="Masukkan Nama. . ." name="nama" value="<?=$_GET['q']?>" /></p>
  </div>
  <div class="form-group" style="width: 400px">
                <p style="color: #fffff;" align="left"><b>Umur</b> <span class="text-danger">*</span></p>
                <input style="color: #000;" class="form-control" type="text" name="umur" required placeholder="Masukkan Umur Anda" />
  </div>

    <div class="form-group" style="width: 400px">
                <p style="color: #fffff;" align="left"><b>Jenis Kelamin</b> <span class="text-danger">*</span></p>
    ...
    <div class="form-group" style="width: 400px">
                <p style="color: #fffff;" align="left"><b>Alamat</b> <span class="text-danger">*</span></p>
                <input style="color: #000;" class="form-control" type="text" name="alamat" required placeholder="Masukkan Alamat" />
  </div>

  <div class="form-group" style="width: 400px">
                <p style="color: #fffff;" align="left"><b>Tanggal Konsultasi</b></span></p>
...
?> - <?= TanggalIndonesia(date('Y-m-d')) ?>" id="jam" />
  ...
  <br>
<div><button class="btn tambah" style="width: 300px">Mulai Konsultasi <span class="glyphicon glyphicon-arrow-right"></span></button>
</div>
</form>
</div>
</body>