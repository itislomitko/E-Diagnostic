...
<div class="panel panel-default">
    <div class="panel-heading">
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-primary" href="?m=relasi_tambah"><span class="glyphicon glyphicon-plus"></span> Tambah Nilai</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
            ...
            <?php
            $q = esc_field($_GET['q']);
            $rows = $db->get_results("SELECT r.ID, r.kode_gejala, d.kode_diagnosa, r.bobot, r.keterangan, g.nama_gejala, d.nama_diagnosa 
            ...
            <tr>
                ...
                <td class="nw">
                    ...
                    <a class="btn btn-xs btn-danger" href="aksi.php?act=relasi_hapus&ID=<?=$row->ID?>" onclick="return confirm('Yakin mau hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
            <?php endforeach;?>
        </table>
