...
<div class="panel panel-default">
    <div class="panel-heading">       
        <form class="form-inline">
            ...
            <div class="form-group">
                <button class="btn tabobotah"><span class="glyphicon glyphicon-search"></span></button>
            </div>
...
<div class="table-responsive">
  ...
  <tr>
    ...
    <td width="100" align="center" valign="middle"><b>Umur</b></td>
 ...
 require_once'functions.php';
    $q = esc_field($_GET['q']);
   // $rows = $db->get_results("SELECT DISTINCT nama,umur,jk,alamat,tgl,hasil_konsultasi,kepercayaan FROM tb_hasil");
    $no=0;
	...
	if(isset($_GET["q"])){
		$q=$_GET["q"];
		$SQL="SELECT * FROM tb_hasil where `nama` like '%$q%' or `alamat` like '%$q%' or `jk` like '%$q%' ";
	}

$rows = $db->get_results($SQL);// WHERE  not `kepercayaan`='' ORDER BY id");//nama LIKE '%$q%' AND
	$_SESSION["csql"]=$SQL;
    foreach($rows as $row):?>
    <tr>
	...
	<td align="center" valign="middle"><?=$row->kepercayaan ?>
